...
func (t *EquipmentT) Pack(builder *flatbuffers.Builder) flatbuffers.UOffsetT {
	...
	case EquipmentAmmunition:
		return t.Value.(*AmmunitionT).Pack(builder)
	}
	return 0
}
...
func (rcv Equipment) UnPack(table flatbuffers.Table) *EquipmentT {
	...
	case EquipmentAmmunition:
		x := Ammunition{_tab: table}
		return &EquipmentT{Type: EquipmentAmmunition, Value: x.UnPack()}
	}
	return nil
}
