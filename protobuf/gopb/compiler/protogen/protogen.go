...
func (opts Options) New(req *pluginpb.CodeGeneratorRequest) (*Plugin, error) {
	...
	//
	//     option go_package = "github.com/jiangshuai341/zbus/protobuf/gopb/types/known/anypb";
	//
...
// For example: "github.com/jiangshuai341/zbus/protobuf/gopb/compiler/protogen"
