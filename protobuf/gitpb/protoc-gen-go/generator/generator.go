...
//
// Deprecated: Use the "github.com/jiangshuai341/zbus/protobuf/gopb/compiler/protogen" package
...
import (
	...
	"github.com/jiangshuai341/zbus/protobuf/gitpb/protoc-gen-go/generator/internal/remap"

	"github.com/jiangshuai341/zbus/protobuf/gitpb/protoc-gen-go/descriptor"
	plugin "github.com/jiangshuai341/zbus/protobuf/gitpb/protoc-gen-go/plugin"
)

func init() {
	fmt.Fprint(os.Stderr,
		"WARNING: Package \"github.com/jiangshuai341/zbus/protobuf/gitpb/protoc-gen-go/generator\" is deprecated.\n"+
...
func (g *Generator) generateImports() {
	...
	g.P(g.Pkg["fmt"] + ` "fmt"`)
	g.P(g.Pkg["math"] + ` "math"`)
	g.P(g.Pkg["proto"]+" ", GoImportPath(g.ImportPrefix)+"github.com/jiangshuai341/zbus/protobuf/gitpb/proto")
