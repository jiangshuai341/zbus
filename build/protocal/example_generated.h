...
#include "include_example_generated.h"
...
template<> struct EquipmentTraits<Example::Weapon> {
...
template<> struct EquipmentUnionTraits<Example::WeaponT> {
  static const Equipment enum_value = Equipment_Weapon;
};
...
struct EquipmentUnion {
  ...
  Example::WeaponT *AsWeapon() {
    return type == Equipment_Weapon ?
      reinterpret_cast<Example::WeaponT *>(value) : nullptr;
  }
  const Example::WeaponT *AsWeapon() const {
    return type == Equipment_Weapon ?
      reinterpret_cast<const Example::WeaponT *>(value) : nullptr;
  }
};
...
struct MonsterT : public flatbuffers::NativeTable {
  ...
  std::unique_ptr<testinclude::Vec3T> pos{};
  int16_t mana = 150;
  int16_t hp = 100;
  std::string name{};
  std::vector<uint8_t> inventory{};
  Example::Color color = Example::Color_Blue;
  std::vector<std::unique_ptr<Example::WeaponT>> weapons{};
  Example::EquipmentUnion equipped{};
  std::vector<std::unique_ptr<testinclude::Vec3T>> path{};
  MonsterT() = default;
...
struct Monster FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const testinclude::Vec3 *pos() const {
    return GetPointer<const testinclude::Vec3 *>(VT_POS);
  }
  int16_t mana() const {
  ...
  Example::Color color() const {
    return static_cast<Example::Color>(GetField<int8_t>(VT_COLOR, 2));
  }
  const flatbuffers::Vector<flatbuffers::Offset<Example::Weapon>> *weapons() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Example::Weapon>> *>(VT_WEAPONS);
  }
  Example::Equipment equipped_type() const {
    return static_cast<Example::Equipment>(GetField<uint8_t>(VT_EQUIPPED_TYPE, 0));
  }
  const void *equipped() const {
    return GetPointer<const void *>(VT_EQUIPPED);
  }
  template<typename T> const T *equipped_as() const;
  const Example::Weapon *equipped_as_Weapon() const {
    return equipped_type() == Example::Equipment_Weapon ? static_cast<const Example::Weapon *>(equipped()) : nullptr;
  }
  const flatbuffers::Vector<flatbuffers::Offset<testinclude::Vec3>> *path() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<testinclude::Vec3>> *>(VT_PATH);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const Example::Weapon *Monster::equipped_as<Example::Weapon>() const {
...
struct MonsterBuilder {
  ...
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_pos(flatbuffers::Offset<testinclude::Vec3> pos) {
  ...
  void add_color(Example::Color color) {
    fbb_.AddElement<int8_t>(Monster::VT_COLOR, static_cast<int8_t>(color), 2);
  }
  void add_weapons(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Example::Weapon>>> weapons) {
    fbb_.AddOffset(Monster::VT_WEAPONS, weapons);
  }
  void add_equipped_type(Example::Equipment equipped_type) {
    fbb_.AddElement<uint8_t>(Monster::VT_EQUIPPED_TYPE, static_cast<uint8_t>(equipped_type), 0);
  }
  void add_equipped(flatbuffers::Offset<void> equipped) {
    fbb_.AddOffset(Monster::VT_EQUIPPED, equipped);
  }
  void add_path(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<testinclude::Vec3>>> path) {
...
inline flatbuffers::Offset<Monster> CreateMonster(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<testinclude::Vec3> pos = 0,
    int16_t mana = 150,
    int16_t hp = 100,
    flatbuffers::Offset<flatbuffers::String> name = 0,
    flatbuffers::Offset<flatbuffers::Vector<uint8_t>> inventory = 0,
    Example::Color color = Example::Color_Blue,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Example::Weapon>>> weapons = 0,
    Example::Equipment equipped_type = Example::Equipment_NONE,
    flatbuffers::Offset<void> equipped = 0,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<testinclude::Vec3>>> path = 0) {
...
inline flatbuffers::Offset<Monster> CreateMonsterDirect(
    ...
    Example::Color color = Example::Color_Blue,
    const std::vector<flatbuffers::Offset<Example::Weapon>> *weapons = nullptr,
    Example::Equipment equipped_type = Example::Equipment_NONE,
    flatbuffers::Offset<void> equipped = 0,
    const std::vector<flatbuffers::Offset<testinclude::Vec3>> *path = nullptr) {
  auto name__ = name ? _fbb.CreateString(name) : 0;
  auto inventory__ = inventory ? _fbb.CreateVector<uint8_t>(*inventory) : 0;
  auto weapons__ = weapons ? _fbb.CreateVector<flatbuffers::Offset<Example::Weapon>>(*weapons) : 0;
  auto path__ = path ? _fbb.CreateVector<flatbuffers::Offset<testinclude::Vec3>>(*path) : 0;
...
inline MonsterT::MonsterT(const MonsterT &o)
      : pos((o.pos) ? new testinclude::Vec3T(*o.pos) : nullptr),
        mana(o.mana),
        hp(o.hp),
        name(o.name),
  ...
  for (const auto &weapons_ : o.weapons) { weapons.emplace_back((weapons_) ? new Example::WeaponT(*weapons_) : nullptr); }
  path.reserve(o.path.size());
  for (const auto &path_ : o.path) { path.emplace_back((path_) ? new testinclude::Vec3T(*path_) : nullptr); }
}
...
inline void Monster::UnPackTo(MonsterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = pos(); if (_e) { if(_o->pos) { _e->UnPackTo(_o->pos.get(), _resolver); } else { _o->pos = std::unique_ptr<testinclude::Vec3T>(_e->UnPack(_resolver)); } } else if (_o->pos) { _o->pos.reset(); } }
  { auto _e = mana(); _o->mana = _e; }
  { auto _e = hp(); _o->hp = _e; }
  { auto _e = name(); if (_e) _o->name = _e->str(); }
  { auto _e = inventory(); if (_e) { _o->inventory.resize(_e->size()); std::copy(_e->begin(), _e->end(), _o->inventory.begin()); } }
  { auto _e = color(); _o->color = _e; }
  { auto _e = weapons(); if (_e) { _o->weapons.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->weapons[_i]) { _e->Get(_i)->UnPackTo(_o->weapons[_i].get(), _resolver); } else { _o->weapons[_i] = std::unique_ptr<Example::WeaponT>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->weapons.resize(0); } }
  { auto _e = equipped_type(); _o->equipped.type = _e; }
  { auto _e = equipped(); if (_e) _o->equipped.value = Example::EquipmentUnion::UnPack(_e, equipped_type(), _resolver); }
  { auto _e = path(); if (_e) { _o->path.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { if(_o->path[_i]) { _e->Get(_i)->UnPackTo(_o->path[_i].get(), _resolver); } else { _o->path[_i] = std::unique_ptr<testinclude::Vec3T>(_e->Get(_i)->UnPack(_resolver)); }; } } else { _o->path.resize(0); } }
}
...
inline flatbuffers::Offset<Monster> CreateMonster(flatbuffers::FlatBufferBuilder &_fbb, const MonsterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _weapons = _o->weapons.size() ? _fbb.CreateVector<flatbuffers::Offset<Example::Weapon>> (_o->weapons.size(), [](size_t i, _VectorArgs *__va) { return CreateWeapon(*__va->__fbb, __va->__o->weapons[i].get(), __va->__rehasher); }, &_va ) : 0;
  auto _equipped_type = _o->equipped.type;
  auto _equipped = _o->equipped.Pack(_fbb);
  auto _path = _o->path.size() ? _fbb.CreateVector<flatbuffers::Offset<testinclude::Vec3>> (_o->path.size(), [](size_t i, _VectorArgs *__va) { return CreateVec3(*__va->__fbb, __va->__o->path[i].get(), __va->__rehasher); }, &_va ) : 0;
  return Example::CreateMonster(
      _fbb,
      _pos,
      _mana,
...
inline bool VerifyEquipment(flatbuffers::Verifier &verifier, const void *obj, Equipment type) {
  switch (type) {
    ...
    case Equipment_Weapon: {
      auto ptr = reinterpret_cast<const Example::Weapon *>(obj);
...
inline flatbuffers::Offset<void> EquipmentUnion::Pack(flatbuffers::FlatBufferBuilder &_fbb, const flatbuffers::rehasher_function_t *_rehasher) const {
  ...
  switch (type) {
    case Equipment_Weapon: {
      auto ptr = reinterpret_cast<const Example::WeaponT *>(value);
...
inline EquipmentUnion::EquipmentUnion(const EquipmentUnion &u) : type(u.type), value(nullptr) {
  switch (type) {
    case Equipment_Weapon: {
      value = new Example::WeaponT(*reinterpret_cast<Example::WeaponT *>(u.value));
      break;
    }
    default:
      break;
...
inline void EquipmentUnion::Reset() {
  switch (type) {
    case Equipment_Weapon: {
      auto ptr = reinterpret_cast<Example::WeaponT *>(value);
      delete ptr;
      break;
    }
    default: break;
...
inline std::unique_ptr<Example::MonsterT> UnPackMonster(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<Example::MonsterT>(GetMonster(buf)->UnPack(res));
}

inline std::unique_ptr<Example::MonsterT> UnPackSizePrefixedMonster(
    const void *buf,
    const flatbuffers::resolver_function_t *res = nullptr) {
  return std::unique_ptr<Example::MonsterT>(GetSizePrefixedMonster(buf)->UnPack(res));
}
